...
create unique index OPERATION_MANAGER_PKI
  on OPERATION_MANAGER(ADMINSTRATOR_ID);

alter table OPERATION_MANAGER
  add constraint OPERATION_MANAGER_PKC primary key (ADMINSTRATOR_ID);
...
create unique index BUS_PKI
  on BUS(BUS_ID);

alter table BUS
  add constraint BUS_PKC primary key (BUS_ID);
...
create unique index SEAT_PKI
  on SEAT(SEAT_ID);

alter table SEAT
  add constraint SEAT_PKC primary key (SEAT_ID);
...
create unique index MEMBER_PKI
  on MEMBER(MEMBER_ID);

alter table MEMBER
  add constraint MEMBER_PKC primary key (MEMBER_ID);
...
create unique index RESERVE_PKI
  on RESERVE(RESERVE_ID);

alter table RESERVE
  add constraint RESERVE_PKC primary key (RESERVE_ID);
...
create unique index ROUTE_PKI
  on ROUTE(ROUTE_ID);

alter table ROUTE
  add constraint ROUTE_PKC primary key (ROUTE_ID);
...
create unique index BUS_STATION_PKI
  on BUS_STATION(BUS_STATION_ID);

alter table BUS_STATION
  add constraint BUS_STATION_PKC primary key (BUS_STATION_ID);
